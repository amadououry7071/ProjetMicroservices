...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Détecter si c'est un compte banni (code 403)
      if (statusCode === 403) {
        setIsBanned(true);
      }
    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary to-primary-dark relative overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white p-12">
          ...
          <h1 className="text-4xl font-bold mb-4 text-center">Bienvenue sur LocaHome</h1>
          <p className="text-xl text-center opacity-90">
            Découvrez des milliers de logements pour votre prochaine aventure
          </p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md animate-fadeIn">
          ...
          {error && (
            <div className={`px-4 py-3 rounded-lg mb-6 animate-fadeIn ${
              isBanned 
              ...
              <div className="flex items-start">
                ...
                <div>
                  <p className={isBanned ? 'font-semibold' : ''}>{error}</p>
                  {isBanned && (
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-gray-500">
              Besoin d'aide ?{' '}
              <a 
                href="mailto:amadouourymargar@gmail.com?subject=Contact LocaHome"
